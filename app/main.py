...
@app.post("/ui/bulk-actions/clear-tags")
def ui_clear_tags() -> dict[str, int]:
    with get_connection() as conn:
...
@app.post("/ui/bulk-actions/import-tags", response_model=BulkTagImportResult)
async def ui_bulk_actions_import_tags(
